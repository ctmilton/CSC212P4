...
public class SpookyMansion implements GameWorld {
	...
	public SpookyMansion() {		
		...
		entranceHall.addExit(new LockedExit("westWing", "Locked. There is a red door in front of you.", "backpack"));
		entranceHall.addItem("backpack");
		entranceHall.addItem("flashlight");
		...
		teaRoom.addExit(new LockedExit("bedroom1", "Locked. There is a fireplace with a door inside of it. You need a key.", "key"));
		entranceHall.addItem("key");
		entranceHall.addItem("spoon");
